...
import { AccountCreationStep } from '@/src/processes/configuration/account-creation-step'
import { DatabaseConfigStep } from '@/src/processes/configuration/database-config-step'
import { ReviewStep } from '@/src/processes/configuration/review-step'
import { ServerConfigurationStep } from '@/src/processes/configuration/server-configuration-step'
import { type Step, Stepper } from '@/src/shared/ui/stepper'
import {
  ClipboardCheckIcon,
  DatabaseIcon,
