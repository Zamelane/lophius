...
export class LanguageManager {
   ...
   */
  public static getAllByEnglishName = cache(async (english_name: string) => {
   ...
   */
  public static getAllByISO_639_1 = cache(async (iso_639_1: string) => {
   ...
   */
  public static getOneByEnglishName = cache(async (english_name: string) => {
   ...
   */
  public static getOneByISO_639_1 = cache(async (iso_639_1: string) => {
    return await db.select().from(languages).where(eq(languages.iso_639_1, iso_639_1)).limit(1)
      .then(v => v.length ? v[0] : undefined)
  })

  public static create = async (data: Language) => {
