...
export const mediaProductionCountries = pgTable('media_production_countries', {
...
export type MediaProductionCountriesTableType = InferSelectModel<typeof mediaProductionCountries>