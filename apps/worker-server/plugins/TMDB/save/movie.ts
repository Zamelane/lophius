...
import { db, Transaction } from "../../../../web-server/database";
...
import {SourceMediaService} from "@/database/services/SourceMediaService.ts";
...
export async function saveMovie(
  ...
  const countryModel = service.countryService.createCountry({
