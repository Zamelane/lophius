...
export const media_production_countries = pgTable(
  'media_production_countries',
  {
    countryId: integer()
      .notNull()
...
export type MediaProductionCountriesTableType =
  typeof media_production_countries.$inferSelect

export const mediaProductionCountriesRelations = relations(
  media_production_countries,
  ({ one, many }) => ({
