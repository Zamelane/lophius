...
import {OptionalLanguageTranslate} from "./type";
...
export class LanguageTranslateModel implements OptionalLanguageTranslate {
	...
	validateRequiredIds(): asserts this is WithRequired<OptionalLanguageTranslate, 'translateValueLanguageId' | 'languageId'> {
